...
The Shortcode to add in functionality to change the Cookie Preference for Cookie that measure website use is:

[cookiepreferences]

This needs to be added in under the Cookies that measure website use section. 

The shortcode can be copied and pasted into the text if using the standard editor.
...
Then shortcode and paste the  shortcode [cookiepreferences] into the Full Shortcode field
...
(Note: This is taken from the [Service Name] website, some sections will not be relevant to your site e.g. Homepage Twitter timeline)
